...
/**
 * InstallerInstallsSearch represents the model behind the search form about `app\models\InstallerInstalls`.
 */
class InstallerInstallsSearch extends InstallerInstalls
{
    /**
     * @inheritdoc
     */
