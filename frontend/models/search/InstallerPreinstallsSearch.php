...
use app\models\InstallerPreinstalls;

/**
 * InstallerPreinstallsSearch represents the model behind the search form about `app\models\InstallerPreinstalls`.
 */
class InstallerPreinstallsSearch extends InstallerPreinstalls
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = InstallerPreinstalls::find();
